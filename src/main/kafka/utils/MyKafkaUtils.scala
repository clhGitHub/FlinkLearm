...
object MyKafkaUtils {
  private val broker_list: String = PropertiesUtils.loadProperties("kafka.broke.list")

  //kafka 消费者配置
  private val kafkaParam: mutable.Map[String, io.Serializable] = collection.mutable.Map(
